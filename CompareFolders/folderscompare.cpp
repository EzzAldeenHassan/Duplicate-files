...
#include "hassan/compare_files.h"
...
{
    // compare
    QDirIterator it1(file_model1_->rootPath(), QDir::Files); // Find files in first folder
    ...
    {                                                        // in 2 folders
        ...
        {
            if(hassan::CompareFiles(dir1_file.toStdString(), dir2_file.toStdString()))
            {
